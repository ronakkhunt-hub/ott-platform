...
const PlayerSection: React.FC = () => {
  return (
    <div className="relative pt-24">
      ...
      ></div>
      <div className={`${classNames.container} relative pt-20 z-10`}>
          ...
          <div className="flex justify-between">
            <div className="flex gap-2 items-center text-white  mt-4">
              ...
              <div className="flex gap-1 items-center">
                <a className="px-2" href="480p">
                  480p
                </a>
                <div className="h-3 w-1 border-l-2 border-sky-900" />
                <a className="px-2" href="720p">
                  720p
                </a>
                <div className="h-3 w-1 border-l-2 border-sky-900" />
                <a className="px-2" href="1080p">
                  1080p
                </a>
                <div className="h-3 w-1 border-l-2 border-sky-900" />
                <a className="px-2" href="4k">
                  4k
                </a>
              </div>
            </div>
